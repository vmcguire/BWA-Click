...
> Do all work in the monorepo: **`~/Developer/bwa-fx-ecosystem/BWA-Click/`**
...
```bash
git subtree push --prefix=BWA-Click git@github.com:vmcguire/BWA-Click.git main
```

Then cut a GitHub Release in this mirror and attach the notarized `BWA-Click.vst3`.
