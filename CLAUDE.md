# BWA-Click — read before doing anything

> ✅ **This is the CANONICAL home for BWA-Click.** All serious DSP, IP, and
> process for this plugin live **here**, in `~/Developer/BWA-Click/`. Author here — always.
>
...
> changes. This file deliberately holds only what is specific to BWA-Click; every
...
4. **`docs/MARKET-PAIN-AND-ATTACKS.md`** — the row for **BWA-Click**; internalize the pain + attack before any DSP.
...
Then cut a GitHub Release here (`vmcguire/BWA-Click`) and attach the notarized `BWA-Click.vst3`.
